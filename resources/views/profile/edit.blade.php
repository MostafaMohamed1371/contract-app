...
@section('content')
    <div class="max-w-lg mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h1 class="text-xl font-bold text-gray-800 mb-4 text-right">الملف الشخصي</h1>
        ...
        <form method="POST" action="{{ route('profile.update') }}" class="space-y-4">
            ...
            <div>
                <label class="block mb-1 text-sm font-medium text-gray-700">كلمة المرور الجديدة (اختياري)</label>
            ...
            <div class="flex justify-end space-x-2 space-x-reverse">
                <a href="{{ route('dashboard') }}" class="px-4 py-2 border rounded-lg text-sm">إلغاء</a>
                <button type="submit"
